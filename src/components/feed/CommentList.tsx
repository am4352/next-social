  ...
  return (
    ...
    {user && (
        <div className="flex items-center gap-4">
              ...
              <form action={add} className="flex items-center justify-between bg-slate-100 rounded-xl text-sm px-6 py-2 w-full">
          ...
          <div className="">
              ...
              {optimisticComments.map(comment=>(
                ...
                <div className="flex gap-4 justify-between mt-6" key={comment.id}>
                  {/* avatar */}
                    <Image src={comment.user.avatar || "/noAvatar.png"} alt=""
                        width={40}
                        height={40}
                        className="w-10 h-10 rounded-full" />
                  {/* desc */}
                  <div className="flex flex-col gap-2 flex-1"><span className="font -medium">
