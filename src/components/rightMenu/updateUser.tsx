                ...
                className="p-12 bg-white rounded-lg shadow-md flex flex-col gap-2 w-full md:w-1/2 xl:w-1/3 relative">
                    ...
                    <div className="flex flex-wrap justify-between gap-2 xl:gap-4">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <input type="text" placeholder={user.name || "Shashwat"}className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm" />
                        </div>
                    </div>
                    {/*INPUTS*/}
                    <div className="flex flex-wrap justify-between gap-2 xl:gap-4">
                        <div className="flex flex-col gap-4">
                            ...
                            <input type="text" placeholder={user.surname || "Mishra"}className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm" />
                        </div>
                    </div>
                    {/*INPUTS*/}
                    <div className="flex flex-wrap justify-between gap-2 xl:gap-4">
                        <div className="flex flex-col gap-4">
                            ...
                            <input type="text" placeholder={user.description || "Life is beautiful..."}className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm" />
                        </div>
                    </div>
                    {/*INPUTS*/}
                    <div className="flex flex-wrap justify-between gap-2 xl:gap-4">
                        <div className="flex flex-col gap-4">
                            ...
                            <input type="text" placeholder={user.city || "Chennai"}className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm" />
                        </div>
                    </div>
                    {/*INPUTS*/}
                    <div className="flex flex-wrap justify-between gap-2 xl:gap-4">
                        <div className="flex flex-col gap-4">
                            ...
                            <input type="text" placeholder={user.school || "SRM"}className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm" />
                        </div>
                    </div>
                    {/*INPUTS*/}
                    <div className="flex flex-wrap justify-between gap-2 xl:gap-4">
                    ...
                    <div className="flex flex-wrap justify-between gap-2 xl:gap-4">
                        <div className="flex flex-col gap-4">
                            ...
                            <input type="text" placeholder={user.website || "lama.dev"}className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm"/>
                        </div>
                    </div>
